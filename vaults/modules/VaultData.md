...
[📄 View Source Code](https://github.com/Ripe-Foundation/ripe-protocol/blob/master/contracts/vaults/modules/VaultData.vy)
...
Only callable by [Lootbox](../../treasury/Lootbox.md) (for reward cleanup)
...
Only callable by [Switchboard](../../governance/Switchboard.md) addresses (governance)
