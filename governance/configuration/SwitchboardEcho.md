...
[📄 View Source Code](https://github.com/Ripe-Foundation/ripe-protocol/blob/4701c43613253fd12e33ac57aaa818caf09b5840/contracts/config/SwitchboardEcho.vy)
...
| --- | --- | --- |
| `addLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, uint256 _amountA, uint256 _amountB, uint256 _minAmountA, uint256 _minAmountB, uint256 _minLpAmount, bytes32 _extraData)` | `4–10` | `_amountA`, `_amountB`, `_minAmountA`, `_minAmountB`, `_minLpAmount`, `_extraData` |
| `claimIncentivesInEndaoment(address _user, uint256 _legoId, address _rewardToken, uint256 _rewardAmount, bytes32[] _proofs)` | `2–5` | `_rewardToken`, `_rewardAmount`, `_proofs` |
| `convertEthToWethInEndaoment(uint256 _amount)` | `0–1` | `_amount` |
| `convertWethToEthInEndaoment(uint256 _amount)` | `0–1` | `_amount` |
| `depositForYieldInEndaoment(uint256 _legoId, address _asset, address _vaultAddr, uint256 _amount, bytes32 _extraData)` | `2–5` | `_vaultAddr`, `_amount`, `_extraData` |
| `finishRipeHqSetup(address _newGov, uint256 _timeLock)` | `1–2` | `_timeLock` |
| `mintPartnerLiquidityInEndaoment(address _partner, address _asset, uint256 _amount)` | `2–3` | `_amount` |
| `removeLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, address _lpToken, uint256 _lpAmount, uint256 _minAmountA, uint256 _minAmountB, bytes32 _extraData)` | `5–9` | `_lpAmount`, `_minAmountA`, `_minAmountB`, `_extraData` |
| `repayPoolDebtInEndaoment(address _pool, uint256 _amount)` | `1–2` | `_amount` |
| `setActionTimeLockAfterSetup(uint256 _newTimeLock)` | `0–1` | `_newTimeLock` |
| `transferFundsToEndaomentPsmInEndaoment(uint256 _amount)` | `0–1` | `_amount` |
| `withdrawFromYieldInEndaoment(uint256 _legoId, address _vaultToken, uint256 _amount, bytes32 _extraData)` | `2–4` | `_amount`, `_extraData` |
| `withdrawFromYieldInPsm(uint256 _amount, bool _shouldTransferToEndaoFunds, bool _shouldFullSweep)` | `0–3` | `_amount`, `_shouldTransferToEndaoFunds`, `_shouldFullSweep` |
...
| `addLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB)` | `nonpayable` | `uint256` |
| `addLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, uint256 _amountA)` | `nonpayable` | `uint256` |
| `addLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, uint256 _amountA, uint256 _amountB)` | `nonpayable` | `uint256` |
| `addLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, uint256 _amountA, uint256 _amountB, uint256 _minAmountA)` | `nonpayable` | `uint256` |
| `addLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, uint256 _amountA, uint256 _amountB, uint256 _minAmountA, uint256 _minAmountB)` | `nonpayable` | `uint256` |
| `addLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, uint256 _amountA, uint256 _amountB, uint256 _minAmountA, uint256 _minAmountB, uint256 _minLpAmount)` | `nonpayable` | `uint256` |
| `addLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, uint256 _amountA, uint256 _amountB, uint256 _minAmountA, uint256 _minAmountB, uint256 _minLpAmount, bytes32 _extraData)` | `nonpayable` | `uint256` |
| `addPartnerLiquidityInEndaoment(uint256 _legoId, address _pool, address _partner, address _asset, uint256 _amount, uint256 _minLpAmount, address _expectedLpToken)` | `nonpayable` | `uint256` |
...
| `claimIncentivesInEndaoment(address _user, uint256 _legoId)` | `nonpayable` | `(uint256, uint256)` |
| `claimIncentivesInEndaoment(address _user, uint256 _legoId, address _rewardToken)` | `nonpayable` | `(uint256, uint256)` |
| `claimIncentivesInEndaoment(address _user, uint256 _legoId, address _rewardToken, uint256 _rewardAmount)` | `nonpayable` | `(uint256, uint256)` |
| `claimIncentivesInEndaoment(address _user, uint256 _legoId, address _rewardToken, uint256 _rewardAmount, bytes32[] _proofs)` | `nonpayable` | `(uint256, uint256)` |
| `confirmGovernanceChange()` | `nonpayable` | — |
| `convertEthToWethInEndaoment()` | `nonpayable` | `(uint256, uint256)` |
| `convertEthToWethInEndaoment(uint256 _amount)` | `nonpayable` | `(uint256, uint256)` |
| `convertWethToEthInEndaoment()` | `nonpayable` | `(uint256, uint256)` |
| `convertWethToEthInEndaoment(uint256 _amount)` | `nonpayable` | `(uint256, uint256)` |
| `depositForYieldInEndaoment(uint256 _legoId, address _asset)` | `nonpayable` | `(uint256, address, uint256, uint256)` |
| `depositForYieldInEndaoment(uint256 _legoId, address _asset, address _vaultAddr)` | `nonpayable` | `(uint256, address, uint256, uint256)` |
| `depositForYieldInEndaoment(uint256 _legoId, address _asset, address _vaultAddr, uint256 _amount)` | `nonpayable` | `(uint256, address, uint256, uint256)` |
| `depositForYieldInEndaoment(uint256 _legoId, address _asset, address _vaultAddr, uint256 _amount, bytes32 _extraData)` | `nonpayable` | `(uint256, address, uint256, uint256)` |
| `depositToYieldInPsm()` | `nonpayable` | `uint256` |
| `disableRipeGovPointAccrualForUser(uint256 _vaultId, address _user)` | `nonpayable` | `uint256` |
| `disableRipeGovPointAccrualGlobally(uint256 _vaultId)` | `nonpayable` | `uint256` |
...
| `isValidRipeGovPointAccrualDisable(uint256 _vaultId, address _user)` | `view` | `bool` |
...
| `mintPartnerLiquidityInEndaoment(address _partner, address _asset)` | `nonpayable` | `uint256` |
| `mintPartnerLiquidityInEndaoment(address _partner, address _asset, uint256 _amount)` | `nonpayable` | `uint256` |
| `numGovChanges()` | `view` | `uint256` |
| `pendingActions(uint256 arg0)` | `view` | `(uint256,uint256,uint256)` |
| `pendingEndaoAddLiquidityActions(uint256 arg0)` | `view` | `(uint256,address,address,address,uint256,uint256,uint256,uint256,uint256,bytes32,address,uint256)` |
| `pendingEndaoPartnerMintActions(uint256 arg0)` | `view` | `(address,address,uint256)` |
| `pendingEndaoPartnerPoolActions(uint256 arg0)` | `view` | `(uint256,address,address,address,uint256,uint256,address)` |
| `pendingEndaoRemoveLiquidityActions(uint256 arg0)` | `view` | `(uint256,address,address,address,uint256,uint256,uint256,uint256,uint256,bytes32,address,uint256)` |
| `pendingEndaoRepayActions(uint256 arg0)` | `view` | `(address,uint256)` |
| `pendingEndaoSwapActions(uint256 arg0, uint256 arg1)` | `view` | `(uint256,uint256,uint256,address[],address[])` |
| `pendingEndaoTransfer(uint256 arg0)` | `view` | `(address,uint256)` |
| `pendingGov()` | `view` | `(address,uint256,uint256)` |
| `pendingPsmSetCanMintActions(uint256 arg0)` | `view` | `(bool)` |
| `pendingPsmSetCanRedeemActions(uint256 arg0)` | `view` | `(bool)` |
| `pendingPsmSetMaxIntervalMintActions(uint256 arg0)` | `view` | `(uint256)` |
| `pendingPsmSetMaxIntervalRedeemActions(uint256 arg0)` | `view` | `(uint256)` |
| `pendingPsmSetMintFeeActions(uint256 arg0)` | `view` | `(uint256)` |
| `pendingPsmSetNumBlocksPerIntervalActions(uint256 arg0)` | `view` | `(uint256)` |
| `pendingPsmSetRedeemFeeActions(uint256 arg0)` | `view` | `(uint256)` |
| `pendingPsmSetShouldAutoDepositActions(uint256 arg0)` | `view` | `(bool)` |
| `pendingPsmSetShouldEnforceMintAllowlistActions(uint256 arg0)` | `view` | `(bool)` |
| `pendingPsmSetShouldEnforceRedeemAllowlistActions(uint256 arg0)` | `view` | `(bool)` |
| `pendingPsmSetUsdcYieldPositionActions(uint256 arg0)` | `view` | `(uint256,address)` |
| `pendingPsmUpdateMintAllowlistActions(uint256 arg0)` | `view` | `(address,bool)` |
| `pendingPsmUpdateRedeemAllowlistActions(uint256 arg0)` | `view` | `(address,bool)` |
| `pendingRipeGovPointAccrualDisableActions(uint256 arg0)` | `view` | `(uint256,address,address)` |
| `performEndaomentSwap((uint256,uint256,uint256,address[],address[])[] _instructions)` | `nonpayable` | `uint256` |
| `performEndaomentTransfer(address _asset, uint256 _amount)` | `nonpayable` | `uint256` |
| `relinquishGov()` | `nonpayable` | — |
| `removeLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, address _lpToken)` | `nonpayable` | `uint256` |
| `removeLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, address _lpToken, uint256 _lpAmount)` | `nonpayable` | `uint256` |
| `removeLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, address _lpToken, uint256 _lpAmount, uint256 _minAmountA)` | `nonpayable` | `uint256` |
| `removeLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, address _lpToken, uint256 _lpAmount, uint256 _minAmountA, uint256 _minAmountB)` | `nonpayable` | `uint256` |
| `removeLiquidityInEndaoment(uint256 _legoId, address _pool, address _tokenA, address _tokenB, address _lpToken, uint256 _lpAmount, uint256 _minAmountA, uint256 _minAmountB, bytes32 _extraData)` | `nonpayable` | `uint256` |
| `repayPoolDebtInEndaoment(address _pool)` | `nonpayable` | `uint256` |
| `repayPoolDebtInEndaoment(address _pool, uint256 _amount)` | `nonpayable` | `uint256` |
...
| `setPsmCanMint(bool _canMint)` | `nonpayable` | `uint256` |
| `setPsmCanRedeem(bool _canRedeem)` | `nonpayable` | `uint256` |
| `setPsmMaxIntervalMint(uint256 _maxGreenAmount)` | `nonpayable` | `uint256` |
| `setPsmMaxIntervalRedeem(uint256 _maxGreenAmount)` | `nonpayable` | `uint256` |
| `setPsmMintFee(uint256 _fee)` | `nonpayable` | `uint256` |
| `setPsmNumBlocksPerInterval(uint256 _blocks)` | `nonpayable` | `uint256` |
| `setPsmRedeemFee(uint256 _fee)` | `nonpayable` | `uint256` |
| `setPsmShouldAutoDeposit(bool _shouldAutoDeposit)` | `nonpayable` | `uint256` |
| `setPsmShouldEnforceMintAllowlist(bool _shouldEnforce)` | `nonpayable` | `uint256` |
| `setPsmShouldEnforceRedeemAllowlist(bool _shouldEnforce)` | `nonpayable` | `uint256` |
| `setPsmUsdcYieldPosition(uint256 _legoId, address _vaultToken)` | `nonpayable` | `uint256` |
| `stabilizeGreenRefPoolInEndaoment()` | `nonpayable` | `bool` |
| `startGovernanceChange(address _newGov)` | `nonpayable` | — |
| `transferFundsToEndaomentPsmInEndaoment()` | `nonpayable` | `(uint256, uint256)` |
| `transferFundsToEndaomentPsmInEndaoment(uint256 _amount)` | `nonpayable` | `(uint256, uint256)` |
| `transferFundsToVaultInEndaoment(address[] _assets)` | `nonpayable` | — |
| `transferUsdcToEndaomentFundsInPsm(uint256 _amount)` | `nonpayable` | `uint256` |
| `updatePsmMintAllowlist(address _user, bool _isAllowed)` | `nonpayable` | `uint256` |
| `updatePsmRedeemAllowlist(address _user, bool _isAllowed)` | `nonpayable` | `uint256` |
| `withdrawFromYieldInEndaoment(uint256 _legoId, address _vaultToken)` | `nonpayable` | `(uint256, address, uint256, uint256)` |
| `withdrawFromYieldInEndaoment(uint256 _legoId, address _vaultToken, uint256 _amount)` | `nonpayable` | `(uint256, address, uint256, uint256)` |
| `withdrawFromYieldInEndaoment(uint256 _legoId, address _vaultToken, uint256 _amount, bytes32 _extraData)` | `nonpayable` | `(uint256, address, uint256, uint256)` |
| `withdrawFromYieldInPsm()` | `nonpayable` | `(uint256, uint256)` |
| `withdrawFromYieldInPsm(uint256 _amount)` | `nonpayable` | `(uint256, uint256)` |
| `withdrawFromYieldInPsm(uint256 _amount, bool _shouldTransferToEndaoFunds)` | `nonpayable` | `(uint256, uint256)` |
| `withdrawFromYieldInPsm(uint256 _amount, bool _shouldTransferToEndaoFunds, bool _shouldFullSweep)` | `nonpayable` | `(uint256, uint256)` |
