...
[📄 View Source Code](https://github.com/Ripe-Foundation/ripe-protocol/blob/4701c43613253fd12e33ac57aaa818caf09b5840/contracts/config/SwitchboardAlpha.vy)
...
| `setAutoStakeParams(uint256 _autoStakeRatio, uint256 _autoStakeDurationRatio, uint256 _stabPoolRipePerDollarClaimed, address _missionControl)` | `3–4` | `_missionControl` |
| `setBorrowIntervalConfig(uint256 _maxBorrowPerInterval, uint256 _numBlocksPerInterval, address _missionControl)` | `2–3` | `_missionControl` |
| `setCanBorrow(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setCanBuyInAuction(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setCanClaimInStabPool(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setCanClaimLoot(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setCanDeposit(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setCanLiquidate(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setCanPerformLiteAction(address _user, bool _canDo, address _missionControl)` | `2–3` | `_missionControl` |
| `setCanRedeemCollateral(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setCanRedeemInStabPool(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setCanRepay(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setCanWithdraw(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setDynamicRateConfig(uint256 _minDynamicRateBoost, uint256 _maxDynamicRateBoost, uint256 _increasePerDangerBlock, uint256 _maxBorrowRate, address _missionControl)` | `4–5` | `_missionControl` |
| `setGenAuctionParams(uint256 _startDiscount, uint256 _maxDiscount, uint256 _delay, uint256 _duration, address _missionControl)` | `4–5` | `_missionControl` |
| `setGlobalDebtLimits(uint256 _perUserDebtLimit, uint256 _globalDebtLimit, uint256 _minDebtAmount, uint256 _numAllowedBorrowers, address _missionControl)` | `4–5` | `_missionControl` |
| `setIsDaowryEnabled(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setKeeperConfig(uint256 _keeperFeeRatio, uint256 _minKeeperFee, uint256 _maxKeeperFee, address _missionControl)` | `3–4` | `_missionControl` |
| `setLtvPaybackBuffer(uint256 _ltvPaybackBuffer, address _missionControl)` | `1–2` | `_missionControl` |
| `setMaxLtvDeviation(uint256 _newDeviation, address _missionControl)` | `1–2` | `_missionControl` |
| `setPriorityLiqAssetVaults(tuple[] _priorityLiqAssetVaults, address _missionControl)` | `1–2` | `_missionControl` |
| `setPriorityPriceSourceIds(uint256[] _priorityIds, address _missionControl)` | `1–2` | `_missionControl` |
| `setPriorityStabVaults(tuple[] _priorityStabVaults, address _missionControl)` | `1–2` | `_missionControl` |
| `setRewardsPointsEnabled(bool _shouldEnable, address _missionControl)` | `1–2` | `_missionControl` |
| `setRipeGovVaultConfig(address _asset, uint256 _assetWeight, bool _shouldFreezeWhenBadDebt, uint256 _minLockDuration, uint256 _maxLockDuration, uint256 _maxLockBoost, uint256 _exitFee, bool _canExit, address _missionControl)` | `8–9` | `_missionControl` |
| `setRipePerBlock(uint256 _ripePerBlock, address _missionControl)` | `1–2` | `_missionControl` |
| `setRipeRewardsAllocs(uint256 _borrowersAlloc, uint256 _stakersAlloc, uint256 _votersAlloc, uint256 _genDepositorsAlloc, address _missionControl)` | `4–5` | `_missionControl` |
| `setStaleTime(uint256 _staleTime, address _missionControl)` | `1–2` | `_missionControl` |
| `setVaultLimits(uint256 _perUserMaxVaults, uint256 _perUserMaxAssetsPerVault, address _missionControl)` | `2–3` | `_missionControl` |
...
| `addPriceSnapshot(address _asset, uint256 _priceSourceId)` | `nonpayable` | `bool` |
| `areValidAuctionParams((bool,uint256,uint256,uint256,uint256) _params)` | `view` | `bool` |
...
| `pendingCanPerformLiteAction(uint256 arg0)` | `view` | `(address,bool)` |
| `pendingDebtConfig(uint256 arg0)` | `view` | `(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256,(bool,uint256,uint256,uint256,uint256))` |
| `pendingGeneralConfig(uint256 arg0)` | `view` | `(uint256,uint256,uint256)` |
| `pendingGov()` | `view` | `(address,uint256,uint256)` |
| `pendingMissionControl(uint256 arg0)` | `view` | `address` |
| `pendingPriorityLiqAssetVaults(uint256 arg0, uint256 arg1)` | `view` | `(uint256,address)` |
| `pendingPriorityPriceSourceIds(uint256 arg0, uint256 arg1)` | `view` | `uint256` |
| `pendingPriorityStabVaults(uint256 arg0, uint256 arg1)` | `view` | `(uint256,address)` |
| `pendingPythMaxConfidenceRatio(uint256 arg0)` | `view` | `uint256` |
| `pendingRipeGovVaultConfig(uint256 arg0)` | `view` | `(address,uint256,bool,(uint256,uint256,uint256,bool,uint256))` |
| `pendingRipeRewardsConfig(uint256 arg0)` | `view` | `(bool,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)` |
...
| `setAutoStakeParams(uint256 _autoStakeRatio, uint256 _autoStakeDurationRatio, uint256 _stabPoolRipePerDollarClaimed)` | `nonpayable` | `uint256` |
| `setAutoStakeParams(uint256 _autoStakeRatio, uint256 _autoStakeDurationRatio, uint256 _stabPoolRipePerDollarClaimed, address _missionControl)` | `nonpayable` | `uint256` |
| `setBorrowIntervalConfig(uint256 _maxBorrowPerInterval, uint256 _numBlocksPerInterval)` | `nonpayable` | `uint256` |
| `setBorrowIntervalConfig(uint256 _maxBorrowPerInterval, uint256 _numBlocksPerInterval, address _missionControl)` | `nonpayable` | `uint256` |
| `setBuybackRatio(uint256 _ratio)` | `nonpayable` | `uint256` |
| `setCanBorrow(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanBorrow(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setCanBuyInAuction(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanBuyInAuction(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setCanClaimInStabPool(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanClaimInStabPool(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setCanClaimLoot(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanClaimLoot(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setCanDeposit(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanDeposit(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setCanLiquidate(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanLiquidate(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setCanPerformLiteAction(address _user, bool _canDo)` | `nonpayable` | `uint256` |
| `setCanPerformLiteAction(address _user, bool _canDo, address _missionControl)` | `nonpayable` | `uint256` |
| `setCanRedeemCollateral(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanRedeemCollateral(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setCanRedeemInStabPool(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanRedeemInStabPool(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setCanRepay(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanRepay(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setCanWithdraw(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setCanWithdraw(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setDynamicRateConfig(uint256 _minDynamicRateBoost, uint256 _maxDynamicRateBoost, uint256 _increasePerDangerBlock, uint256 _maxBorrowRate)` | `nonpayable` | `uint256` |
| `setDynamicRateConfig(uint256 _minDynamicRateBoost, uint256 _maxDynamicRateBoost, uint256 _increasePerDangerBlock, uint256 _maxBorrowRate, address _missionControl)` | `nonpayable` | `uint256` |
| `setExpiration(uint256 _expiration)` | `nonpayable` | `bool` |
| `setGenAuctionParams(uint256 _startDiscount, uint256 _maxDiscount, uint256 _delay, uint256 _duration)` | `nonpayable` | `uint256` |
| `setGenAuctionParams(uint256 _startDiscount, uint256 _maxDiscount, uint256 _delay, uint256 _duration, address _missionControl)` | `nonpayable` | `uint256` |
| `setGlobalDebtLimits(uint256 _perUserDebtLimit, uint256 _globalDebtLimit, uint256 _minDebtAmount, uint256 _numAllowedBorrowers)` | `nonpayable` | `uint256` |
| `setGlobalDebtLimits(uint256 _perUserDebtLimit, uint256 _globalDebtLimit, uint256 _minDebtAmount, uint256 _numAllowedBorrowers, address _missionControl)` | `nonpayable` | `uint256` |
| `setGovTimeLock(uint256 _numBlocks)` | `nonpayable` | `bool` |
| `setIsDaowryEnabled(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setIsDaowryEnabled(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setKeeperConfig(uint256 _keeperFeeRatio, uint256 _minKeeperFee, uint256 _maxKeeperFee)` | `nonpayable` | `uint256` |
| `setKeeperConfig(uint256 _keeperFeeRatio, uint256 _minKeeperFee, uint256 _maxKeeperFee, address _missionControl)` | `nonpayable` | `uint256` |
| `setLtvPaybackBuffer(uint256 _ltvPaybackBuffer)` | `nonpayable` | `uint256` |
| `setLtvPaybackBuffer(uint256 _ltvPaybackBuffer, address _missionControl)` | `nonpayable` | `uint256` |
| `setMaxLtvDeviation(uint256 _newDeviation)` | `nonpayable` | `uint256` |
| `setMaxLtvDeviation(uint256 _newDeviation, address _missionControl)` | `nonpayable` | `uint256` |
| `setPriorityLiqAssetVaults((uint256,address)[] _priorityLiqAssetVaults)` | `nonpayable` | `uint256` |
| `setPriorityLiqAssetVaults((uint256,address)[] _priorityLiqAssetVaults, address _missionControl)` | `nonpayable` | `uint256` |
| `setPriorityPriceSourceIds(uint256[] _priorityIds)` | `nonpayable` | `uint256` |
| `setPriorityPriceSourceIds(uint256[] _priorityIds, address _missionControl)` | `nonpayable` | `uint256` |
| `setPriorityStabVaults((uint256,address)[] _priorityStabVaults)` | `nonpayable` | `uint256` |
| `setPriorityStabVaults((uint256,address)[] _priorityStabVaults, address _missionControl)` | `nonpayable` | `uint256` |
| `setPythMaxConfidenceRatio(uint256 _ratio)` | `nonpayable` | `uint256` |
| `setRewardsPointsEnabled(bool _shouldEnable)` | `nonpayable` | `bool` |
| `setRewardsPointsEnabled(bool _shouldEnable, address _missionControl)` | `nonpayable` | `bool` |
| `setRipeGovVaultConfig(address _asset, uint256 _assetWeight, bool _shouldFreezeWhenBadDebt, uint256 _minLockDuration, uint256 _maxLockDuration, uint256 _maxLockBoost, uint256 _exitFee, bool _canExit)` | `nonpayable` | `uint256` |
| `setRipeGovVaultConfig(address _asset, uint256 _assetWeight, bool _shouldFreezeWhenBadDebt, uint256 _minLockDuration, uint256 _maxLockDuration, uint256 _maxLockBoost, uint256 _exitFee, bool _canExit, address _missionControl)` | `nonpayable` | `uint256` |
| `setRipePerBlock(uint256 _ripePerBlock)` | `nonpayable` | `uint256` |
| `setRipePerBlock(uint256 _ripePerBlock, address _missionControl)` | `nonpayable` | `uint256` |
| `setRipeRewardsAllocs(uint256 _borrowersAlloc, uint256 _stakersAlloc, uint256 _votersAlloc, uint256 _genDepositorsAlloc)` | `nonpayable` | `uint256` |
| `setRipeRewardsAllocs(uint256 _borrowersAlloc, uint256 _stakersAlloc, uint256 _votersAlloc, uint256 _genDepositorsAlloc, address _missionControl)` | `nonpayable` | `uint256` |
| `setStaleTime(uint256 _staleTime)` | `nonpayable` | `uint256` |
| `setStaleTime(uint256 _staleTime, address _missionControl)` | `nonpayable` | `uint256` |
| `setUndyVaultDiscount(uint256 _discount)` | `nonpayable` | `uint256` |
| `setVaultLimits(uint256 _perUserMaxVaults, uint256 _perUserMaxAssetsPerVault)` | `nonpayable` | `uint256` |
| `setVaultLimits(uint256 _perUserMaxVaults, uint256 _perUserMaxAssetsPerVault, address _missionControl)` | `nonpayable` | `uint256` |
